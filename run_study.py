...
useIBT = "noIBT"
results_path = f"/srv/STP/results_relevance_{RELEVANCE_THR}_redundancy_{REDUNDANCY_THR}_study_{useIBT}"
...
def _run_experiment(parameters, best_score):
    ...
    print(f"Nested MCC: {nested_metrics['mcc']}")
    print(f"Nested Params: {nested_metrics['hyperparameter_tuning']}")

    if nested_metrics['mcc'] > best_score:
        best_score = nested_metrics['mcc']
...
config_path = f"/srv/STP/study_configs_{useIBT}"
