...
def _run_nested_cross_validation(subset_df_A, subset_df_B, metadata_df_A,
    ...
    for train_idx, test_idx in tqdm(outer_splits, desc="Outer CV Splits"):
        ...
        def suggest_svc_params(trial, prefix="model__"):
            ...
            # 'rbf', 'model__C': 21.365739988927572, 'model__max_iter': 100, 'model__gamma': 0.0010982262620960058} 68
            # 'rbf', 'model__C': 21.809181686813197, 'model__max_iter': 100, 'model__gamma': 0.0010816876654119662} 69
            ...
            C = trial.suggest_categorical(f"{prefix}C", [21.809181686813197])
            ...
            if kernel in {"rbf", "sigmoid"}:
                ...
                gamma = trial.suggest_categorical(f"{prefix}gamma", [0.0010816876654119662])
            ...
            class_weight_0 = trial.suggest_float(f"{prefix}class_weight_0", 1e-2, 1.0, log=True)
            class_weight_1 = trial.suggest_float(f"{prefix}class_weight_1", 4, 100, log=True)
        ...
        def build_pipeline_from_svc_params(params):
            ...
            class_weight_0 = params["model__class_weight_0"]
            class_weight_1 = params["model__class_weight_1"]
            class_weight = {0: class_weight_0, 1: class_weight_1}
