...
aov.to_csv(f"study_2_two_way_anova_results_{useIBT}_rel_{rel_thr}_red_{red_thr}.csv", index=False)
p_motion.to_csv(f"study_2_motion_post_hocs_{useIBT}_rel_{rel_thr}_red_{red_thr}.csv", index=False)
p_spatial.to_csv(f"study_2_spatial_post_hocs_{useIBT}_rel_{rel_thr}_red_{red_thr}.csv", index=False)