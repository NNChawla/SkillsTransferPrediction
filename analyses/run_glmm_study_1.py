...
def parse_combo(combo_str):
    ...
    elif combo_str == "linvel":
        return (("Velocity",), ("Linear",))
    elif combo_str == "linvel_angvel":
        return (("Velocity",), ("Linear", "Angular"))
    elif combo_str == "pos":
        return (("Position",), ("Linear",))
    elif combo_str == "quat":
        return (("Position",), ("Angular",))
    elif combo_str == "pos_quat":
        return (("Position",), ("Linear", "Angular"))
    elif combo_str == "pos_linvel":
        return (("Position", "Velocity"), ("Linear",))
    elif combo_str == "quat_angvel":
        return (("Position", "Velocity"), ("Angular",))
    elif combo_str == "pos_quat_linvel_angvel":
        return (("Position", "Velocity"), ("Linear", "Angular"))
    else:
        raise ValueError(f"Unknown combo: {combo_str}")
...
with open(f"glmm_study_1_results_summary_{useIBT}.txt", "w") as f:
    f.write(str(glmm_results.summary()))

# Save the model object itself
with open(f"glmm_study_1_model_{useIBT}.pkl", "wb") as f:
    pickle.dump(glmm_results, f)

print(f"\nAnalysis complete. Results saved to glmm_study_1_results_summary_{useIBT}.txt")
