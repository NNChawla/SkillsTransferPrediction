...
score_A = metadata_dataframe["Score_A_Linear"].apply(lambda x: 1 if x > 0 else 0)
score_B = metadata_dataframe["Score_B_Linear"].apply(lambda x: 1 if x > 0 else 0)
...
include_set_feature_A, include_set_feature_B = ["A_RW_Build_Time"], ["B_RW_Build_Time"]
exclude_set_feature_A, exclude_set_feature_B = ["B_RW_Build_Time"], ["A_RW_Build_Time"]
...
metadata_binary_features = list(set([i.replace("A-", "X-").replace("B-", "X-").replace("ARW-", "XRW-").replace("BRW-", "XRW-") for i in metadata_binary_features]))
...
metadata_A_features, metadata_B_features = list(zip(*[(i.replace("X-", "A-").replace("XRW-", "ARW-"), i.replace("X-", "B-").replace("XRW-", "BRW-")) for i in metadata_binary_features]))
...
with open("/srv/STP/top_valid_cross_fstat_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_fstat_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "F-Statistic_A", "F-Statistic_B", "Harmonic Mean"])
...
with open("/srv/STP/top_valid_cross_spearman_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_spearman_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "Spearman Correlation_A", "Spearman Correlation_B", "Harmonic Mean"])
...
with open("/srv/STP/top_valid_cross_pearson_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_pearson_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "Pearson Correlation_A", "Pearson Correlation_B", "Harmonic Mean"])
...
with open("/srv/STP/top_valid_cross_mutual_information_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_mutual_information_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "Mutual Information_A", "Mutual Information_B", "Harmonic Mean"])
...
with open("/srv/STP/top_valid_cross_point_biserial_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_point_biserial_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "Point-Biserial Correlation_A", "Point-Biserial Correlation_B", "Harmonic Mean"])
...
with open("/srv/STP/top_valid_cross_ks_stat_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_ks_stat_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "KS-Statistic_A", "KS-Statistic_B", "Harmonic Mean"])
...
with open("/srv/STP/top_valid_cross_chisq_features.csv", "w") as f:
    writer = csv.writer(f)
...
with open("/srv/STP/top_valid_within_chisq_features.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(["Feature", "Chi-Square_A", "Chi-Square_B", "Harmonic Mean"])
